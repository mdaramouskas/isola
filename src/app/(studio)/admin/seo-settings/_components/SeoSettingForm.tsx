...
export default function SeoSettingForm({
    ...
    const {
        ...
        defaultValues: {
            ...
            siteName: seoSettingItem?.siteName || "Isola Boutique",
            siteTitle: seoSettingItem?.siteTitle || "Home Page",
            metadescription: seoSettingItem?.metadescription || "Isola Boutique is a next.js e-commerce boilerplate built with nextjs, typescript, tailwindcss, and prisma.",
            metaImage: {
